...
server = 'ec2-54-70-241-186.us-west-2.compute.amazonaws.com' # this is production instance
server_uri = 'ec2-54-70-241-186.us-west-2.compute.amazonaws.com'
env = 'production' # the dev server is in test env
branch = "master"
...
set :repository, 'git@github.com:SGourshete/MovieReview_DemoProject.git'
set :branch, branch
set :rails_env, env
